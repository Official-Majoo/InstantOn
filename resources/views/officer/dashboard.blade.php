                ...
                <div class="card-body p-0">
                    ...
                    @else
                        <div class="text-center py-5">
                            <img src="{{ asset('images/empty-concept-illustration.png') }}" alt="Empty Queue" style="width: 120px;" class="mb-3">
                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center py-4">
                            <img src="{{ asset('images/empty-concept-illustration.png') }}" alt="No Activity" style="width: 100px;" class="mb-3">
